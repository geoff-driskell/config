...
class Presence(hass.Hass):
    def initialize(self):
        ...
        self.listen_state(self.presence_change, "person")
        ...
        # self.set_state("sensor.geoff_tracker", state="away")
        # self.set_state("sensor.vicki_tracker", state="away")
    ...
    def presence_event(self, event_name, data, kwargs):
        ...
        tracker = "Unknown"
        if event_tracker == "Geoff":
            tracker = globals.geoff_tracker_id
        elif event_tracker == "Vicki":
            tracker = globals.vicki_tracker_id
